...
const Crash = () => {
    ...
    if (startGame) {
      ...
      const interval = setInterval(() => {
        ...
        if (intervalPeriod > 10) {
          setIntervalPeriod(((intervalPeriod) => intervalPeriod - (intervalPeriod * 0.001)))
              }
      }, intervalPeriod)
  ...
  if (startGame === true) {
    ...
    renderCrash = (
      <span>Crashed! {multiplierLembrance.toFixed(2)}</span>
    )
  }

      
>>>>>>> d2e8d1e1e52129317e6f86a24491315c872e1ccb
